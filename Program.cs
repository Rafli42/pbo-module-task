...
class coba
{
    ...
    {
        singa singa1= new singa(4, "Singa Raja", 10);
        gajah gajah1=new gajah(4,"Gajah Mada",10);
        buaya buaya1 = new buaya(3, "Buaya Laut", 2);
        ular ular1 = new ular(5, "Ular Phyton", 2);
...
public class buaya : Reptil
{
    ...
    public override string Suara()
    {
        return "\nBuaya bersuara : kalo aku chat ada yang mara ga?";
    }
}
